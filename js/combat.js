...
const WEAPON_TYPES = {
  ...
  boltX:  { name:'Doom Bolt',      icon:'wpn_bolt',     desc:'Evolved: piercing barrage', mode:'aim', hidden:true,
            dmg:28, rate:2.4, range:13, count:2, pierce:4, speed:20, life:1.6, color:0xff66ff, shape:'doom' },
  spreadX:{ name:'Hex Storm',      icon:'wpn_spread', desc:'Evolved: shard storm',      mode:'spread', hidden:true,
            dmg:16, rate:1.6, range:11, count:5, pierce:2, speed:18, life:1.1, color:0x99eeff, arc:0.78, shape:'shard' },
  novaX:  { name:'Supernova',      icon:'wpn_nova',  desc:'Evolved: massive blast',    mode:'nova', hidden:true,
            dmg:24, rate:1.15, range:0, count:2, pierce:99, speed:15, life:0.8, color:0xffd24a, radius:4.5 },
  orbitX: { name:'Death Orbit',    icon:'wpn_orbit', desc:'Evolved: lethal orbs',      mode:'orbit', hidden:true,
            dmg:13, count:4, color:0xff3366, orbitR:2.5, orbitSpd:3.8, tick:0.30 },
  arrowX: { name:'Tempest Volley', icon:'wpn_arrow', desc:'Evolved: storm of arrows',  mode:'aim', hidden:true,
            dmg:30, rate:1.7, range:18, count:3, pierce:6, speed:30, life:1.9, color:0xc8ff7a, shape:'arrow' },
  smiteX: { name:'Divine Judgment', icon:'wpn_smite', desc:'Evolved: heaven’s wrath', mode:'smite', hidden:true,
            dmg:40, rate:1.2, range:12, count:2, pierce:3, speed:14, life:1.4, color:0xffe9a0, radius:3.0 },
  bladewhirlX:{ name:'Tempest Blades', icon:'wpn_bladewhirl', desc:'Evolved: blade cyclone', mode:'slash', hidden:true,
            dmg:22, rate:2.4, range:4.6, count:3, pierce:3, speed:10, life:0.46, color:0xff7a88, arc:0.9, shape:'crescent' },
  soulspiralX:{ name:'Soul Tempest', icon:'wpn_soulspiral', desc:'Evolved: spectral maelstrom', mode:'spiral', hidden:true,
